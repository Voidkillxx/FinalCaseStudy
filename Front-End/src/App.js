...
import { Alert, Container, Spinner, Modal } from 'react-bootstrap'; // Added Modal import for Confirmation
...
function AppContent() {
    ...
    const [showRemoveConfirm, setShowRemoveConfirm] = useState(false); // New state for confirmation
